...
var animation_mapping = {
	"enemy-run" : "orthrus-run",
	"enemy-attack" : "orthrus-attack",
	"enemy-idle" : "orthrus-idle",
	"enemy-hit" : "orthrus-hit",
	"enemy-dead" : "orthrus-death"
}
