...
var animation_mapping = {
	"enemy-run" : "eurytheon-run",
	"enemy-attack" : "eurytheon-attack",
	"enemy-idle" : "eurytheon-idle",
	"enemy-hit" : "eurytheon-hit",
	"enemy-dead" : "eurytheon-death"
}
