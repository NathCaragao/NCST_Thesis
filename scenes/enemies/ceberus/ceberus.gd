...
var animation_mapping = {
	"enemy-run" : "ceberus-run",
	"enemy-attack" : "ceberus-attack",
	"enemy-idle" : "ceberus-idle",
	"enemy-hit" : "ceberus-hit",
	"enemy-dead" : "ceberus-death"
}
