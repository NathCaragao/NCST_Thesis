...
var animation_mapping = {
	...
	"enemy-attack" : "diomedes-attack",
	"enemy-idle" : "diomedes-idle",
	"enemy-hit" : "diomedes-hit",
	"enemy-dead" : "diomedes-death"
}
...
func flip_sprite() -> void:
	if velocity.x > 0:
		sprite.flip_h = false
		$EnemyHealthComp/Hitbox/HitboxCollision.position.x = 26
	elif velocity.x < 0:
		sprite.flip_h = true
		$EnemyHealthComp/Hitbox/HitboxCollision.position.x = -26
